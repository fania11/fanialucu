...
<body>
    ...
    <header>
        <nav class="navbar bg-body-tertiary">
            ...
            <ul class="nav justify-content-end" >
                ...
                <li class="nav-item">
                    <a class="{{ Request::is('login') ? 'nav-link active' : 'nav-link' }}"
                    href="{{ url('login') }}"
                    role="button">login</a>
                </li>
            </ul>
    ...
    <figure class="text-center" >
        ...
        <b><h1>Selamat datang di fanshop</b></h1>
        </blockquote>
    ...
    <!---->
    <main class="mt-0 bg-gray-50">
        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
            <a
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/moistskin.jpeg') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">MOISTURIZER SKINTIFIC PINK</h2>
                <p class="mt-4 text-sm/relaxed">
                    Skintific Moisturizer Pink istimewa adalah formulanya yang kaya akan peptida dan ekstrak tumbuh-tumbuhan. Salah satu komponen utamanya adalah Hyaluronic Acid, yang dikenal mampu mengikat kelembapan sehingga kulit terasa lebih plump dan lembab.
                </p>
            </div>
            </a>
            ...
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/serum.jpg') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">SERUM SKINTIFIC PINK</h2>
                <p class="mt-4 text-sm/relaxed">
                    Serum Skintific warna pink ini dapat diandalkan untuk mencerahkan wajah kamu, ya. Tampaknya, memang semua produk dari Skintific, termasuk kedua serumnya ini, memiliki kandungan ceramide
                </p>
            </div>
            </a>
            ...
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/cucimuka.jpg') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">FACIAL WASH SKINTIFIC PINK</h2>
                <p class="mt-4 text-sm/relaxed">
                    Dengan kemasan 80 ml, Skintific Facial Wash Warna Pink cocok untuk semua jenis kulit. Produk ini memiliki pH yang mendekati pH kulit wajah, tidak membuat kulit terasa tertarik, dan mengandung 5 jenis ceramide yang berbeda untuk menutrisi dan menjaga skin barrier kulit.
                </p>
            </div>
            </a>
            ...
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/toner.jpg') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">TONER SKINTIFIC PINK</h2>
                <p class="mt-4 text-sm/relaxed">
                    Skintific pink toner atau Skintific Glycolic Acid Daily Clarifying Toner berfungsi untuk mencerahkan kulit, melawan jerawat, dan mengurangi tampilan pori-pori. Toner ini juga dapat mengangkat sel kulit mati dan menjaga skin barrier.
                </p>
            </div>
            </a>
            ...
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/lipserum8.jpg') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">LIP SERUM SKINTIFIC</h2>
                <p class="mt-4 text-sm/relaxed">
                    Lip serum Skintific berfungsi untuk melembapkan, mencerahkan, dan menghaluskan bibir. Lip serum ini juga dapat meratakan warna bibir dan mengatasi masalah bibir kering, gelap, dan garis-garis.
                </p>
            </div>
            </a>
            ...
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/cushion.png') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">CUSHION SKINTIFIC</h2>
                <p class="mt-4 text-sm/relaxed">
                    Skintific Cover All Perfect Cushion shade Sand cocok untuk kulit gelap dengan undertone hangat. Shade ini memiliki warna coklat dengan sedikit sentuhan merah yang cocok untuk kulit gelap dengan undertone hangat.
                </p>
            </div>
            </a>
            ...
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/claypink.jpg') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">CLAYSTICK SKINTIFIC PINK</h2>
                <p class="mt-4 text-sm/relaxed">
                    SKINTIFIC Niacinamide Bright Boost Clay Stick adalah produk booster pendukung untuk mencerahkan yang mengandung Niacinamide, Pink Sea Salt, dan Tranexamic Acid untuk mencerahkan dan meratakan warna kulit. Bersinergi untuk mendapatkan kulit yang glowing, cerah dan tetap sehat.
                </p>
            </div>
            </a>
            ...
            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            <div>
                <img src="{{ asset('img/claystickhijau.jpg') }}" width="550" height="550">
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black ">CLAYSTICK SKINTIFIC HIJAU</h2>
                <p class="mt-4 text-sm/relaxed">
                    Skintific Cover All Perfect Cushion shade Sand cocok untuk kulit gelap dengan undertone hangat. Shade ini memiliki warna coklat dengan sedikit sentuhan merah yang cocok untuk kulit gelap dengan undertone hangat.
                </p>
            </div>
    ...
    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
        Ulin Nikmah Farah Khoirun Nisa'
    </footer>
